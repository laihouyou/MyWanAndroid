...
import com.lhy.demo.action.SwipeAction;
import com.lhy.demo.helper.ActivityStackManager;
import com.lhy.demo.http.model.RequestHandler;
import com.lhy.demo.http.server.ReleaseServer;
import com.lhy.demo.http.server.TestServer;
import com.lhy.demo.other.AppConfig;
import com.lhy.demo.ui.activity.CrashActivity;
...
public final class MyApplication extends Application {
    ...
    public static void initSDK(Application application) {
        ...
        // Bugly 异常捕捉
        CrashReport.initCrashReport(application, AppConfig.getBuglyId(), true);
